        ...
        <form enctype="multipart/form-data" action="/index.php/Admin/Goods/edit/id/7.html" method="post">
            ...
            <table width="90%" class="tab_table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        From: <input type="text" id="promote_start_date" name="promote_start_date" value="<?php echo $data['promote_start_date']; ?>" size="20" />
                        To: <input type="text" id="promote_end_date" name="promote_end_date" value="<?php echo $data['promote_end_date']; ?>" size="20" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="test" name="sort_num" value="<?php echo $data['sort_num'];?>" size="8"/><br />
                        <span style="color:#F00;font-size:12px;font-weight:bold;">数字小显示在前面！</span>
                    </td>
                </tr>
            </table>
            <!-- 商品描述 -->
