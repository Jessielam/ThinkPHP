    ...
    <form name="main_form" method="POST" action="/index.php/Admin/Attribute/edit/id/1/type_id/1.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea name="attr_option_values" id="attr_option_values" cols="50"><?php echo $data['attr_option_values']; ?></textarea>
                </td>
            </tr>
            <tr>
                <td class="label">所属类型：</td>
                <td>
                    <?php echo buildSelect('Type','type_id','id','type_name',I('get.id')); ?>
                </td>
            </tr>
            <tr>
