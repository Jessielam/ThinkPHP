        ...
        <form enctype="multipart/form-data" action="/index.php/Admin/Goods/add.html" method="post">
            <table width="90%" class="tab_table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        ￥ <input type="text" name="promote_price" value="0.00" size="10"/> 元<br /> 
                    </td>
                </tr>
                <tr>
                    <td class="label">促销时间：</td>
                    <td>
                        From <input type="text" name="promote_start_time" id="promote_start_time" value=""/>
                        To <input type="text" name="promote_end_time" id="promote_end_time" value=""/> 
                    </td>
                </tr>
                <tr>
