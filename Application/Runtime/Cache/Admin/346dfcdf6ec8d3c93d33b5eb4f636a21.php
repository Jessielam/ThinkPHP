        ...
        <form enctype="multipart/form-data" action="/index.php/Admin/Goods/add.html" method="post">
            ...
            <table width="90%" class="tab_table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="promote_price" value="0.00" size="20" />
                    </td>
                </tr>
                <tr>
                    <td class="label">促销时间：</td>
                    <td>
                        From: <input type="text" id="promote_start_date" name="promote_start_date" value="" size="20" />
                        To: <input type="text" id="promote_end_date" name="promote_end_date" value="" size="20" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="test" name="sort_num" value="100" size="8"/><br />
