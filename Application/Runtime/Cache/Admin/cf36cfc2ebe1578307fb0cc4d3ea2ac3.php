            ...
            <tr>
                ...
                <td>
                    <?php foreach($priData as $k=>$v): if(strpos(','.$rpData.',',','.$v['id'].',')!==FALSE){ $check = 'checked="checked"'; }else{ $check = ''; } ?>
                        ...
                        <input  <?php echo $check; ?> level_id=<?php echo $v['level'];?> type="checkbox" name="pri_id[]" value="<?php echo $v['id']; ?>"/><?php echo $v['pri_name']; ?>
                        <br />
                    <?php endforeach; ?>
                </td>
            </tr>
...
<script type="text/javascript"> 
    ...
    $(":checkbox").click(function(){
        ...
        if($(this).prop("checked")){
            ...
            //如果是取消选中，所有的子权限也都取消选中
            $(this).nextAll(':checked').each(function(k,v){
                if($(v).attr("level_id")>level_id){
