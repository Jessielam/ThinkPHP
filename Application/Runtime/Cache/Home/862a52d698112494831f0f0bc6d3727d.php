...
$.ajax({
	...
	success: function(data){
		...
		$(data).each(function(k,v){
			html += '<dl><dt><a href="<?php echo U('goods', '', FALSE); ?>/id/'+v.id+'"><img src="'+viewPath+v.mid_logo+'"/></a></dt><dd><a href="<?php U('goods','',FALSE); ?>/id/'+v.id+'">'+v.goods_name+'</a></dd></dl>';
		});
		//放到页面中去
		...
		<div class="summary">
			...
			<div class="goodsinfo fl ml10">
				<ul>
					...
					<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo $info['market_price']; ?></strong> <a href="">(降价通知)</a></li>
					...
					<li class="shop_price"><span>购买价格：</span><strong id="buy_price" style="font-size: 20px"></strong></li>
...
<script>
	$.ajax({
		type: "GET",
		url : "<?php echo U('ajaxGetMemberPrice?goodsId='.$info['id']); ?>",
		success:function(data){
			$('#buy_price').html("￥"+data+"元");
		}
	});
</script>
